      ...
      <main className="lg:ml-64">
        ...
        <div className="px-6 py-12">
          <div className="bg-card border border-border rounded-lg p-8 text-center">
            <h2 className="text-2xl font-bold text-foreground mb-4">Transformers Module</h2>
            <p className="text-muted-foreground">This page will display all transformer units and their real-time data.</p>
          </div>
        </div>
      </main>
    </div>
